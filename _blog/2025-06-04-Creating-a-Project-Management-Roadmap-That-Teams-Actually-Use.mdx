...
This is more common than most teams realize. In fact, [42% of project managers don’t follow a defined project management methodology](https://plaky.com/learn/project-management/project-management-statistics/). These teams are 15% less likely to meet their goals and 16% less likely to finish on time. That’s a lot of wasted time and effort. But it doesn’t have to be this way.
...
AppFlowy makes it easy to get your roadmap up and running. Instead of spending hours building a layout from scratch, you can use a pre-built [roadmap document template](https://appflowy.com/templates/product-design/bb4839d1-5379-4947-8cf2-12fa3a7a69a6). With flexible views, drag-and-drop options, and customizable properties, the setup process is smooth. You can start quickly, personalize your content, and make updates whenever needed.
...
### Step 1: Save The Roadmap Document Template into Your AppFlowy Workspace

[This template](https://appflowy.com/templates/product-design/bb4839d1-5379-4947-8cf2-12fa3a7a69a6) gives you a head start by providing a flexible, customizable structure. You can start building your plan right away without having to design from scratch.

### Step 2: Organize your roadmap info using database properties

Once inside the template, begin adding your content. AppFlowy’s rich property types let you organize your data based on your needs, so it’s easy to visualize key elements at a glance.

### Step 3: Customize The Views to Match Your Initiative

Each view has different goals. Create a Grid view for key milestones, build a launch plan calendar, and add checklists to break work into actionable tasks tailored to your specific initiative.
...
Assign due dates, tag responsible team members, and use color-coding tags and groups to highlight priorities. These features help ensure clarity and alignment with stakeholder expectations throughout the lifecycle of the plan.
...
AppFlowy allows you to customize data to match the current phase. That means you’re not stuck with outdated information. Instead, your roadmap becomes a living tool that changes with your work.
...
| --------- | ----------------------------- | ----------------------------------- |
| Planning  | Goals, resources, timelines   | Add text properties, attach files   |
| Execution | Tasks, owners, deliverables   | Use checklists, assign team members |
| Review    | Feedback, changes, next steps | Add nested pages or text properties |
...
We understand how frustrating it can be to build a roadmap that no one ends up using. That’s why [AppFlowy](https://appflowy.com/) is built to support plans that stay relevant, flexible, and easy to update as your project changes.
...
[Download AppFlowy](https://appflowy.com/download) to learn how to create a project roadmap that supports your initiative, aligns with stakeholder expectations, and helps you create a plan your team will actually follow.
