    ...
    },
    {
      ...
      desc: (
        <div>
          ...
          <br />
          <div>
            Users worry about entrusting sensitive data to these tools and are naturally concerned about their
            longevity.
      ...
      desc: (
        <div className={'our-mission-desc'}>
          ...
          <div className={'list'}>
            ...
            <div>
              Build an open source codebase with a community-driven open toolbox of plugins, templates, and themes so
              you
