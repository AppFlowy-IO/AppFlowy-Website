export const termsHTML = `<h1>Terms & Conditions</h1>
<p>Updated at 2022-08-04</p>

<h1>General Terms</h1>
<p>By accessing and placing an order with https://www.appflowy.io/, you confirm that you are in agreement with and bound
    by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website
    and any email or other type of communication between you and https://www.appflowy.io/.</p>
<p>Under no circumstances shall https://www.appflowy.io/ team be liable for any direct, indirect, special, incidental or
    consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the
    inability to use, the materials on this site, even if https://www.appflowy.io/ team or an authorized representative
...
<p>https://www.appflowy.io/ will not be responsible for any outcome that may occur during the course of usage of our
...
<h1>License</h1>
<p>https://www.appflowy.io/ grants you a revocable, non-exclusive, non-transferable, limited license to download,
    install and use the website strictly in accordance with the terms of this Agreement.</p>
<p>These Terms & Conditions are a contract between you and https://www.appflowy.io/ (referred to in these Terms &
    Conditions as "https://www.appflowy.io/", "us", "we" or "our"), the provider of the https://www.appflowy.io/ website
    and the services accessible from the https://www.appflowy.io/ website (which are collectively referred to in these
    Terms & Conditions as the "https://www.appflowy.io/ Service").</p>
<p>You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms & Conditions, please do
    not use the https://www.appflowy.io/ Service. In these Terms & Conditions, "you" refers both to you as an individual
    and to the entity you represent. If you violate any of these Terms & Conditions, we reserve the right to cancel your
...
<ul>
    ...
    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to APPFLOWY PTE. LTD., 30 Prinsep
        Street, Singapore, Singapore, 188647 that is responsible for your information under this Terms & Conditions.
    </li>
    <li>Country: where https://www.appflowy.io/ or the owners/founders of https://www.appflowy.io/ are based, in this
        case is
    </li>
    <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to
        visit https://www.appflowy.io/ and use the services.
    </li>
    <li>Service: refers to the service provided by https://www.appflowy.io/ as described in the relative terms (if
    ...
    <li>Website: https://www.appflowy.io/'s site, which can be accessed via this URL: https://www.appflowy.io/</li>
    <li>You: a person or entity that is registered with https://www.appflowy.io/ to use the Services.</li>
</ul>
...
<ul>
    ...
    <li>Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of
        https://www.appflowy.io/ or its affiliates, partners, suppliers or the licensors of the website.
    </li>
</ul>
<h1>Return and Refund Policy</h1>
<p>Thanks for shopping at https://www.appflowy.io/. We appreciate the fact that you like to buy the stuff we build. We
...
<p>As with any shopping experience, there are terms and conditions that apply to transactions at
    https://www.appflowy.io/. We’ll be as brief as our attorneys will allow. The main thing to remember is that by
    placing an order or making a purchase at https://www.appflowy.io/, you agree to the terms along with
    https://www.appflowy.io/'s Privacy Policy.</p>
...
<p>Any feedback, comments, ideas, improvements or suggestions (collectively, "Suggestions") provided by you to
    https://www.appflowy.io/ with respect to the website shall remain the sole and exclusive property of
    https://www.appflowy.io/.</p>
<p>https://www.appflowy.io/ shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose
...
<p>We've updated our Terms & Conditions to provide you with complete transparency into what is being set when you visit
    ...
    consent to our Terms & Conditions.</p>

<h1>Links to Other Websites</h1>
<p>This Terms & Conditions applies only to the Services. The Services may contain links to other websites not operated
    or controlled by https://www.appflowy.io/. We are not responsible for the content, accuracy or opinions expressed in
...
<h1>Cookies</h1>
<p>https://www.appflowy.io/ uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a
...
<p>You acknowledge and agree that https://www.appflowy.io/ may stop (permanently or temporarily) providing the Service
    (or any features within the Service) to you or to users generally at sole discretion, without prior notice to you.
    You may stop using the Service at any time. You do not need to specifically inform https://www.appflowy.io/ when you
    stop using the Service. You acknowledge and agree that if https://www.appflowy.io/ disables access to your account,
...
<p>https://www.appflowy.io/ reserves the right to modify, suspend or discontinue, temporarily or permanently, the
    website
    or any service to which it connects, with or without notice and without liability to you.</p>

<h1>Updates to Our website</h1>
<p>https://www.appflowy.io/ may from time to time provide enhancements or improvements to the features/ functionality of
...
<p>Updates may modify or delete certain features and/or functionalities of the website. You agree that
    https://www.appflowy.io/ has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any
    particular features and/or functionalities of the website to you.</p>
<p>You further agree that all Updates will be (i) deemed to constitute an integral part of the website, and (ii) subject
...
<p>You acknowledge and agree that https://www.appflowy.io/ shall not be responsible for any Third-Party Services,
    including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or
    any other aspect thereof. https://www.appflowy.io/ does not assume and shall not have any liability or
...
<p>This Agreement shall remain in effect until terminated by you or https://www.appflowy.io/.</p>
<p>https://www.appflowy.io/ may, in its sole discretion, at any time and for any or no reason, suspend or terminate this
    Agreement with or without prior notice.</p>
<p>This Agreement will terminate immediately, without prior notice from https://www.appflowy.io/, in the event that you
...
<p>Upon termination of this Agreement, you shall cease all use of the website and delete all copies of the website from
    your computer.</p>
<p>Termination of this Agreement will not limit any of https://www.appflowy.io/'s rights or remedies at law or in equity
...
<p>You agree to indemnify and hold https://www.appflowy.io/ and its parents, subsidiaries, affiliates, officers,
...
<p>The website is provided to you "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of any
    kind. To the maximum extent permitted under applicable law, https://www.appflowy.io/, on its own behalf and on
    ...
    https://www.appflowy.io/ provides no warranty or undertaking, and makes no representation of any kind that the
    website will meet your requirements, achieve any intended results, be compatible or work with any other software, ,
...
<p>Without limiting the foregoing, neither https://www.appflowy.io/ nor any https://www.appflowy.io/'s provider makes
    ...
    provided through the website; or (iv) that the website, its servers, the content, or e-mails sent from or on behalf
    of https://www.appflowy.io/ are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful
    components.</p>
...
<p>Notwithstanding any damages that you might incur, the entire liability of https://www.appflowy.io/ and any of its
...
<p>To the maximum extent permitted by applicable law, in no event shall https://www.appflowy.io/ or its suppliers be
    ...
    Agreement), even if https://www.appflowy.io/ or any supplier has been advised of the possibility of such damages and
...
<p>This Agreement, together with the Privacy Policy and any other legal notices published by https://www.appflowy.io/ on
    the Services, shall constitute the entire agreement between you and https://www.appflowy.io/ concerning the
    Services. If any provision of this Agreement is deemed invalid by a court of competent jurisdiction, the invalidity
    of such provision shall not affect the validity of the remaining provisions of this Agreement, which shall remain in
    full force and effect. No waiver of any term of this Agreement shall be deemed a further or continuing waiver of
    such term or any other term, and https://www.appflowy.io/'s failure to assert any right or provision under this
    Agreement shall not constitute a waiver of such right or provision. YOU AND https://www.appflowy.io/ AGREE THAT ANY
    CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE SERVICES MUST COMMENCE WITHIN ONE (1) YEAR AFTER THE CAUSE OF
...
<p>https://www.appflowy.io/ reserves the right, at its sole discretion, to modify or replace this Agreement at any time.
...
<p>By continuing to access or use our website after any revisions become effective, you agree to be bound by the revised
    terms. If you do not agree to the new terms, you are no longer authorized to use https://www.appflowy.io/.</p>

<h1>Entire Agreement</h1>
<p>The Agreement constitutes the entire agreement between you and https://www.appflowy.io/ regarding your use of the
...
<p>You may be subject to additional terms and conditions that apply when you use or purchase other
    https://www.appflowy.io/'s services, which https://www.appflowy.io/ will provide to you at the time of such use or
    purchase.</p>
...
<p>The website and its entire contents, features and functionality (including but not limited to all information,
    ...
    https://www.appflowy.io/, its licensors or other providers of such material and are protected by and international
    ...
    express prior written permission of https://www.appflowy.io/, unless and except as is expressly provided in these
...
<p>This section applies to any dispute EXCEPT IT DOESN’T INCLUDE A DISPUTE RELATING TO CLAIMS FOR INJUNCTIVE OR
    EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR https://www.appflowy.io/'s INTELLECTUAL PROPERTY
    RIGHTS. The term “dispute” means any dispute, action, or other controversy between you and https://www.appflowy.io/
...
<p>If you and https://www.appflowy.io/ don’t resolve any dispute by informal negotiation, any other effort to resolve
...
<p>In the event that you submit or post any ideas, creative suggestions, designs, photographs, information,
    ...
    non-proprietary and will become the sole property of https://www.appflowy.io/ without any compensation or credit to
    you whatsoever. https://www.appflowy.io/ and its affiliates shall have no obligations with respect to such
    submissions or posts and may use the ideas contained in such submissions or posts for any purposes in any medium in
    perpetuity, including, but not limited to, developing, manufacturing, and marketing products and services using such
    ideas.</p>

<h1>Promotions</h1>
<p>https://www.appflowy.io/ may, from time to time, include contests, promotions, sweepstakes, or other activities
...
<p>If for any reason a court of competent jurisdiction finds any provision or portion of these Terms & Conditions to be
    ...
    provision of these Terms & Conditions will be effective only if in writing and signed by an authorized
    representative of https://www.appflowy.io/. https://www.appflowy.io/ will be entitled to injunctive or other
    equitable relief (without the obligations of posting any bond or surety) in the event of any breach or anticipatory
    breach by you. https://www.appflowy.io/ operates and controls the https://www.appflowy.io/ Service from its offices
    in . The Service is not intended for distribution to or use by any person or entity in any jurisdiction or country
    where such distribution or use would be contrary to law or regulation. Accordingly, those persons who choose to
    access the https://www.appflowy.io/ Service from other locations do so on their own initiative and are solely
    responsible for compliance with local laws, if and to the extent local laws are applicable. These Terms & Conditions
    (which include and incorporate the https://www.appflowy.io/ Privacy Policy) contains the entire understanding, and
    supersedes all prior understandings, between you and https://www.appflowy.io/ concerning its subject matter, and
    cannot be changed or modified by you. The section headings used in this Agreement are for convenience only and will
    not be given any legal import.</p>

<h1>Disclaimer</h1>
<p>https://www.appflowy.io/ is not responsible for any content, code or any other imprecision.</p>
<p>https://www.appflowy.io/ does not provide warranties or guarantees.</p>
<p>In no event shall https://www.appflowy.io/ be liable for any special, direct, indirect, consequential, or incidental
...
<p>The https://www.appflowy.io/ Service and its contents are provided "as is" and "as available" without any warranty or
    representations of any kind, whether express or implied. https://www.appflowy.io/ is a distributor and not a
    publisher of the content supplied by third parties; as such, https://www.appflowy.io/ exercises no editorial control
    over such content and makes no warranty or representation as to the accuracy, reliability or currency of any
    information, content, service or merchandise provided through or accessible via the https://www.appflowy.io/
    Service. Without limiting the foregoing, https://www.appflowy.io/ specifically disclaims all warranties and
    representations in any content transmitted on or in connection with the https://www.appflowy.io/ Service or on sites
    that may appear as links on the https://www.appflowy.io/ Service, or in the products provided as a part of, or
    otherwise in connection with, the https://www.appflowy.io/ Service, including without limitation any warranties of
    merchantability, fitness for a particular purpose or non-infringement of third party rights. No oral advice or
    written information given by https://www.appflowy.io/ or any of its affiliates, employees, officers, directors,
    agents, or the like will create a warranty. Price and availability information is subject to change without notice.
    Without limiting the foregoing, https://www.appflowy.io/ does not warrant that the https://www.appflowy.io/ Service
