  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: "Vault Workspace is a special AI workspace type that Notion doesn't support. It provides a full-featured AI that runs entirely on your device, a rich-text editor that supports 40+ content types and database views for organizing information, and local AI search that answers questions fully offline without a single byte leaving your vault. It is designed for professionals, such as portfolio managers, healthcare consultants, and high-tech research scientists, who need maximum control over sensitive data. This combination of local storage, offline access, and locally running AI provides a level of privacy and data ownership that is difficult to achieve with traditional cloud-first workspace platforms. Notion does not offer an equivalent workspace type that combines local data storage with support for locally hosted AI models.",
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: "AppFlowy's database capabilities have advanced significantly and are among the most feature-complete options available for organizations seeking a self-hosted alternative to Notion. AppFlowy currently supports: Grid (table), Kanban, Calendar, Gallery, List, Feed, Chart views, along with Advanced filters, Two-way relations, Rollups, Calculations, Database templates, Grouping and Sorting options, Linked views of data source, Multi-row bulk actions. For most project management, CRM, wiki, operations, and knowledge management use cases, AppFlowy's databases provide everything teams need. Notion still maintains an advantage with Timeline and Map views. However, AppFlowy is actively investing in database development and continues to close the remaining feature gaps while offering deployment flexibility and data ownership that Notion cannot provide.",
        },
      },
      {
        '@type': 'Question',
