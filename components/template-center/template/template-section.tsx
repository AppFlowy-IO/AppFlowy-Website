      ...
      <div className={'template-section-main'}>
        ...
        <div className={'template-section-main-header'}>
          <div className={'flex flex-1 flex-col gap-6'}>
            <div>
              <h1 className={'template-section-main-header-title'}>{template.name}</h1>
              {/* Kept whitespace-pre-wrap/break-words, previously inherited from the
                  title element this description used to be nested inside. */}
              <div className={'template-section-main-header-desc mt-4 whitespace-pre-wrap break-words'}>
        ...
        <div className={'flex flex-col gap-6'}>
          ...
          <div className={'flex w-full items-center justify-center gap-5'}>
            <Link className={'flex items-center gap-2 text-primary'} href={useTemplateURL} target={'_blank'}>
            ...
            <Link className={'flex items-center gap-2 text-primary'} href={template.view_url} target={'_blank'}>
              <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 20 20' fill='none'>
                <path
